(function($) {
    ...
    $(function() {
        ...
        document.querySelectorAll("#sideNav .b-sidenav-sub__title").forEach(function(sub) {
            sub.addEventListener("click", function(e) {
                e.preventDefault();
                e.target.parentNode.querySelector(".b-sidenav-sub__menu").classList.toggle("i-open");
            });
        });
        $(".b-flat-choice img").click(function(e) {
            e.preventDefault();
            $(".b-flat-choice__flats").addClass("i-show");
        });
        window.processFotoramaTouch = [];
        $(document).delegate("#process .b-photo-card", "click", function(e) {
            var $photoCard = $(this);
            setTimeout(function() {
        ...
        $("#process .fotorama").on("fotorama:show", function() {
        ...
        var c = {
            ...
            getCaret: function() {
                try {
                    ...
                    if (e && -1 === navigator.appVersion.indexOf("MSIE 10")) a = e.createRange(), a.moveStart("character", -c.val().length), 
                    r = a.text.length; else if (f || "0" === f) r = f;
                    return r;
                } catch (C) {}
            },
            setCaret: function(a) {
                try {
                    if (b.is(":focus")) {
                        var c, g = b.get(0);
                        g.setSelectionRange ? g.setSelectionRange(a, a) : (c = g.createTextRange(), c.collapse(!0), 
                        c.moveEnd("character", a), c.moveStart("character", a), c.select());
                    }
                } catch (B) {}
            },
            events: function() {
            ...
            calculateCaretPosition: function() {
                ...
                if (a !== e) {
                    ...
                    g > d ? g = 10 * e : f >= g && f !== d ? c.maskDigitPosMapOld[g] || (f = g, g = g - (l - h) - a, 
...
!function() {
    ...
    var b = [], c = function(a) {
        var b;
        return window.CustomEvent && "function" == typeof window.CustomEvent ? b = new CustomEvent(a) : (b = document.createEvent("CustomEvent"), 
        b.initCustomEvent(a, !1, !1, void 0)), b;
    }, d = function(a) {
    ...
    a.extend = function(a, c, d) {
        ...
        init: function(a, b) {
            ...
            if (c) {
                var h = function() {
                    g.current && g.current !== this && g.current.removeAttribute("aria-sort"), g.current = this, 
                    g.sortTable(this);
                };
                for (e = 0; e < c.cells.length; e++) f = c.cells[e], f.setAttribute("role", "columnheader"), 
                "none" !== f.getAttribute("data-sort-method") && (f.tabindex = 0, f.addEventListener("click", h, !1), 
                null !== f.getAttribute("data-sort-default") && (d = f));
                d && (g.current = d, g.sortTable(d));
            }
        },
        sortTable: function(a, g) {
            var h = this, i = a.cellIndex, j = e, k = "", l = [], m = h.thead ? 0 : 1, n = a.getAttribute("data-sort-method"), o = a.getAttribute("aria-sort");
            if (h.table.dispatchEvent(c("beforeSort")), g || (o = "ascending" === o ? "descending" : "descending" === o ? "ascending" : h.options.descending ? "descending" : "ascending", 
            a.setAttribute("aria-sort", o)), !(h.table.rows.length < 2)) {
                if (!n) {
                    for (;l.length < 3 && m < h.table.tBodies[0].rows.length; ) k = d(h.table.tBodies[0].rows[m].cells[i]), 
                    k = k.trim(), k.length > 0 && l.push(k), m++;
                    if (!l) return;
                }
                ...
                for (h.col = i, m = 0; m < h.table.tBodies.length; m++) {
                    ...
                    if (!(h.table.tBodies[m].rows.length < 2)) {
                        for (p = 0; p < h.table.tBodies[m].rows.length; p++) k = h.table.tBodies[m].rows[p], 
                        "none" === k.getAttribute("data-sort-method") ? r[s] = k : q.push({
                            tr: k,
                            td: d(k.cells[h.col]),
                            index: s
                        }), s++;
                        for ("descending" === o ? q.sort(f(j, !0)) : (q.sort(f(j, !1)), q.reverse()), p = 0; p < s; p++) r[p] ? (k = r[p], 
                        t++) : k = q[p - t].tr, h.table.tBodies[m].appendChild(k);
                    }
                }
...
!function() {
    var a = function(a) {
        ...
        return a = parseFloat(a), b = parseFloat(b), a = isNaN(a) ? 0 : a, b = isNaN(b) ? 0 : b, 
        a - b;
    };
